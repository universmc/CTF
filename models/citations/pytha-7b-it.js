 ...
 const citation_Pythagore = `${sujet} ${verbe} ${complement}. ${contexte}`;
  ...
  groq.chat.completions.create({
    ...
    const outputFilePath =
      "build/Pythagore_" + new Date().toISOString().replace(/[-:TZ]/g, "") + ".md";
